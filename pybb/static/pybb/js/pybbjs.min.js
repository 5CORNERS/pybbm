...
$(".tooltip-who-liked-container .fa-chevron-right").on("click",function(){var a=$(this).parent();a.get(0).scrollTo(a.scrollLeft()+a.width(),0)});$(".tooltip-who-liked-container .fa-chevron-left").on("click",function(){var a=$(this).parent();a.get(0).scrollTo(a.scrollLeft()+-a.width(),0)});var tooltipShowTimer,tooltipHideTimer,delay,touch=touch||void 0;delay=touch?0:500;
