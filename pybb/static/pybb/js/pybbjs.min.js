...
$(".tooltip-who-liked-text").on("click",function(a){a='<div id="modalWindow" class="modal hide fade in" style="display:none;"><div class="modal-header"><a class="close" data-dismiss="modal">\u00d7</a>'+("<h4>"+heading+"</h4>");a=a+'</div><div class="modal-body"><p>'+formContent;a+='</div><div class="modal-footer">';""!=btnText&&(a=a+'<span class="btn btn-success"'+(' onClick="'+strSubmitFunc+'">'+btnText),a+="</span>");a+='<span class="btn" data-dismiss="modal">Close</span></div></div>';$("#"+placementId).html(a);
$("#modalWindow").modal()});
