...
$(".tooltip-who-liked-container .fa-chevron-right").on("click",function(){var a=$(this).parent();a.get(0).scrollTo(a.scrollLeft()+a.width(),0)});$(".tooltip-who-liked-container .fa-chevron-left").on("click",function(){var a=$(this).parent();a.get(0).scrollTo(a.scrollLeft()+-a.width(),0)});var tooltipShowTimer,tooltipHideTimer;
$(".like-container").mouseover(function(){if($(this).hasClass("show-tooltip"))clearTimeout(tooltipHideTimer);else{var a=$(this);tooltipShowTimer=setTimeout(function(b){b=void 0===b?a:b;b.addClass("show-tooltip")},500)}});$(".like-container").mouseout(function(){if($(this).hasClass("show-tooltip")){var a=$(this);tooltipHideTimer=setTimeout(function(b){b=void 0===b?a:b;b.removeClass("show-tooltip")},500)}else clearTimeout(tooltipShowTimer)});
